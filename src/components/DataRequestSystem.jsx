    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-teal-50">
      ...
      <div style={{ textAlign: 'center', marginTop: '20px' }}>
        <div className="container" style={{
          ...
          <h1 style={{ textAlign: 'center', color: '#2c3e50' }}>Qatar Open Data Portal - Dataset Request Process</h1>
          <p style={{ margin: '10px 0' }}><strong>Example: Processing a Dataset Request for Economic Development Data</strong></p>
          ...
          <h2 style={{ color: '#2c3e50', marginTop: '20px' }}>1. Request Submission</h2>
          <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
            <li style={{ marginBottom: '10px' }}>The researcher uses the online dataset request submission form on the Qatar Open Data Portal to specify their need for a combined dataset on economic and workforce metrics.</li>
            <li style={{ marginBottom: '10px' }}>The form captures details like the dataset’s purpose (e.g., academic research), preferred format (e.g., CSV), and any specific timeframes (e.g., 2020–2025).</li>
          </ul>
          ...
          <h2 style={{ color: '#2c3e50', marginTop: '20px' }}>4. Request Tracking</h2>
          <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
            <li style={{ marginBottom: '10px' }}>The researcher tracks the request’s status via the portal’s request tracking interface, which shows updates like “Request received,” “Under review by Ministry of Commerce,” or “Pending data compilation.”</li>
            <li style={{ marginBottom: '10px' }}>The interface is user-friendly, reflecting the portal’s commitment to transparency and public engagement.</li>
          </ul>
